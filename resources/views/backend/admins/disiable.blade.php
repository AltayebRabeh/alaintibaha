...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800" style="float:right">المدراء المحظورين</h1>
                        ...
                        @forelse($admins as $key => $value)
                            <tr class="{{ $value->status == 0 ? 'alert-warning' : '' }}">
                                ...
                                <td>
                                    ...
                                    <a href="#" id="hide-btn" data-hide="{{ route('admin.admins.status', $value->id) }}" data-toggle="modal" data-target="#hideModal" class="d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm"><i class="fas fa- fa-sm text-white-50"></i> إلغاء الحظر </a>
                                </td>
                            </tr>
                        @empty
                            <tr>
