            ...
            <div class="card mp-5">
                ...
                <div class="card-body mp-5">
                    <form method="POST" action="{{ route('register') }}"  enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="photo" class="col-md-4 col-form-label text-md-right">الاسم</label>
                        ...
                        <div class="form-group row">
                            <label for="sex" class="col-md-4 col-form-label text-md-right">الجنس</label>
                        ...
                        <div class="form-group row">
                            <label for="age" class="col-md-4 col-form-label text-md-right">العمر</label>
